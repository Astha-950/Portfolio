...
\usepackage[
    pdftitle={Astha Chaurasia's CV},
    pdfauthor={Astha Chaurasia},
...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Astha Chaurasia
        ...
        \mbox{\hrefWithoutArrow{mailto:asthachaurasia272006@gmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+91-9752294198}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/astha-chaurasia-825605253/}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/Asthachaurasia?tab=repositories}}%
    \end{header}
